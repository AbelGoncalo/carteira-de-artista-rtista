...
<link rel="stylesheet" type="text/css" href="/assets/admin/css/select2.min.css">
    <link rel="stylesheet" type="text/css" href="/assets/admin/css/select2-bootstrap4.min.css">
    <!-- Page Wrapper -->
    <div id="wrapper">
            ...
            <div class="card">
                ...
                <div class="col-md-12 align-items-start">
                    <div class="form-group">
                        <label for="">Promotores de eventos:</label>
                        <select multiple class="form-control"  name="promotor_evento_id[]" id="artist">
                            <option value="" selected disabled>Selecionar</option>
                            @foreach($promoters as $promotor_event)
                                 <option value="{{$promotor_event->id}}">{{$promotor_event->name ?? ''}}</option>
                            @endforeach
                        </select>
                ...
                <div class="form-group my-3">
                    ...
                    <textarea class="form-control" name="texto" cols="30" rows="10"></textarea>
                </div>
