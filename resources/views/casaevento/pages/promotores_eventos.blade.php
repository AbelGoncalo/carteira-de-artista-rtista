                            ...
                            @foreach($promoters as $promoter)
                                <div class="card mx-2" style="width: 18rem;">
                                    <div class="container" style="border-radius: 100%; width: 100px; height: 100px; border: 2px solid #3d2822 ;">
                                        ...
                                        <div class="card-body">
                                            <h5 class="card-title text-uppercase text-center">{{$promoter->name ?? ''}}</h5>
                                            <p class="card-text">
                                                </p>
                                            <div class="d-flex justify-content-center ">
                                                <!-- <a style="background: #3d2822;" href="{{route('carteira.artista.form.invite.promoter.event')}}" class="btn text-white">Convidar</a> -->
                                            </div>
