...
<div class='container  col-md-6' style="margin-top:20vh">
    <h3 class="text-center text-uppercase" style='color:#3d2822;'>Processo de finalização de inscrição</h3>
    ...
    <form method="post" action="{{route('carteira.artista.finish.send.details.of.payment.pdf',$id)}}" class="my-3" enctype="multipart/form-data">
        @csrf
        <div class='form-group'>
            <input  name='comprovativo' accept="pdf,docx" type="file" class='form-control' required />
        </div>
