                                ...
                                <div class="card-body">
                                  ...
                                  <!-- Fim Filtro de mensagens-->
                                        ...
                                        @foreach($allmessages as $messages)
                                            <div class="d-flex mb-2 flex-column">
                                                <div class="d-flex align-items-center">
                                                    {{-- <span class='h6 text-uppercase my-1 font-weight-bold'>Utilizador: <span style="font-weight: bold !important">{{isset($messages->name) ? $messages->name : ''}}</span></span> --}}

                                                </div>

                                                <div class="">
                                                    <div class='mb-3 d-flex flex-column my-2'>
                                                    ...
                                                    <div class="d-flex align-items-start">
                                                        <p class=" my-2"> {{$messages->message ?? ''}}</p>
                                    ...
                                    @endif
                                        ...
                                        <div class="d-flex align-items-center">
                                            {{-- {{isset($allmessages) ? $allmessages->links() : ""}} --}}
