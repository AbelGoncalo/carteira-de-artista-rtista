                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card shadow">
                                ...
                                <div class="card-body">
                                    ...
                                    @if(isset($allmessagesForArtists))
                                        @if(count($allmessagesForArtists) < 1) 
                                                <div class="alert alert-warning col-md-12 text-center">
                                                    <span>Nenhuma mensagem disponível</span>
                                                </div>
                                        @endif

                                        @foreach($allmessagesForArtists as $messages)
                                        <div class="d-flex mb-2 flex-column">

                                            <div class="d-flex align-items-start mb-2">
                                                <img class="img-fluid" width='40' src='/assets/admin/img/undraw_profile.svg' />
                                                <span class='h6 text-uppercase mx-3 my-1 font-weight-bold'>Artista: <span style="font-weight: bold !important">{{$messages->nome_completo ?? ''}}</span></span>
