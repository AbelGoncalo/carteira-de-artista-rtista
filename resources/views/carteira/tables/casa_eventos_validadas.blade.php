                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card shadow">
                                <div style="background: #3d2822;" class="card-header text-light">
                                    <h4>Casas de Eventos Validadas pela carteira</h4>
                                </div>

                                <div class="card-body">
                                    @if(isset($validatedHousesOfEvents) ? count($validatedHousesOfEvents) < 1 : '')
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-hover table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach($validatedHousesOfEvents as $house)
                                                    <tr>
                                                        <td>{{$house->id ?? ''}}</td>
                                                        <td>{{$house->name ?? ''}}</td>
